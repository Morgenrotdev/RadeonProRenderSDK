...
rpr_status CreateAMDFloor(rpr_context context, rpr_scene scene, rpr_material_system matsys, RPRGarbageCollector& gc, float scaleX, float scaleY, float translationX, float translationY, float translationZ)
{
	...
	rpr_material_node uv_node = NULL;
	{
		...
		const std::string pathImageFileA = "../../Resources/Textures/art.jpg";
...
rpr_status CreateAMDFloorIN(rpr_context context, rpr_scene scene, rpr_material_system matsys, RPRGarbageCollector& gc, float scaleX, float scaleY, float translationX, float translationY, float translationZ, std::string pathImageFileA)
{
	// Create plane mesh
	rpr_shape plane = nullptr;
	{
