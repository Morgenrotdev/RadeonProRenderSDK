...
json_data = {
    ...
    "obj0": {
        "name": "floor",
        "geomObjFile": "../../Resources/Meshes//s.obj",
        "translation": [-3,0,0],
        "scale": [1,1,1]
    },
    "obj1": {
    ...
    "obj2": {
        "name": "floor",
        "geomObjFile": "../../Resources/Meshes/r.obj",
        "translation": [3,0,0],
        "scale": [1,1,1]
    },
        "ibl":
...
for idx in range(0, len(positions), 6):
    position = positions[idx + 3 : idx + 6]
    obj_name = f"obj{idx//6 + 3}"  # 元のJSONにはobj0, obj1, obj2があるため
    json_data[obj_name] = {
        "name": "sphere",
        "geomObjFile": "../../Resources/Meshes/r.obj",  # この部分は適切なファイルパスに変更してください
