project "99_test"
    kind "ConsoleApp"
    location "../build"
    files { "../32_gl_interop/ShaderManager.h", "../32_gl_interop/ShaderManager.cpp"} 
    files { "../common/common.cpp","../common/common.h"}
    files { "../99_test/**.cpp","../99_test/**.h" }

    -- remove filters for Visual Studio
   -- vpaths { [""] = {  "../32_gl_interop/ShaderManager.h", "../32_gl_interop/ShaderManager.cpp" ,"../common/common.cpp","../common/common.h",  "../99_test/**.cpp", "../99_test/**.h"} }
