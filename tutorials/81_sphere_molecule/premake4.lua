project "81_sphere_molecule"
    kind "ConsoleApp"
    location "../build"
    files { "../81_sphere_molecule/**.h", "../81_sphere_molecule/**.cpp"} 
    files { "../common/common.cpp","../common/common.h"}

    -- remove filters for Visual Studio
    vpaths { [""] = { "../81_sphere_molecule/**.h", "../81_sphere_molecule/**.cpp","../common/common.cpp","../common/common.h"} }
